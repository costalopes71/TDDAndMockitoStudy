...
public class OrderDaoJpaImpl implements OrderDao {
	...
	@Override
	public List<OrderEntity> findOrdersByCustomer(long customerId) throws DataAccessException {
		throw new NotImplementedException();
	}

	@Override
	public int insertReturningInt(OrderEntity order) throws DataAccessException {
